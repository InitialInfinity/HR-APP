            ...
            body: SafeArea(
              child: Column(
                children: [
                  ...
                  FormBuilder(
                    key: staffController.fbKeyAddStaff,
                    child: Expanded(
                      child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              TextFormFieldWidget(
                                ...
                                inputFormatter: r'[0-9 A-Z a-z]',
                                onTap: () {
                                  showDatePickerStaffDOE(
                                      staffController.exitDate,
              ...
              () {
                return staffController.isLoading.value
                    ...
                    : Container(
                        ...
                        child: ButtonWidget(
                          onPressed: () {
                            if (staffController.fbKeyAddStaff.currentState!
                                .saveAndValidate()) {
