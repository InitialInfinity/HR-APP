...
class SalaryEditPage extends StatelessWidget {
  const SalaryEditPage({super.key});
        ...
        child: SafeArea(
          child: Obx(
            () {
              return Column(
                children: [
                  AppBarWidget("Update Salary", false, () {}, true, true),
                  FormBuilder(
                    key: salaryController.fbKeyUpdateSalary,
                    child: Expanded(
                      child: Padding(
